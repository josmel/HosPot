...
class Default_GenreController extends Core_Controller_ActionDefault
{
    const _TABLECLASS = 'Genre';
    ...
    public function listAction()
    {
        ...
        try {
            ...
            if(!empty($search['value']))
                $arrSearch[] = array("g.name like ?", '%'.$search['value'].'%');
    ...
    public function tableIcons(){
        return '<a href="javascript:;" data-id="__ID__" data-target="#tplGenre" title="Editar" class="padding-right-small lnkEdit"><i class="fa fa-pencil"></i></a><a class="lnkDel" data-id="__ID__" title="Eliminar" href="javascript:;"><i class="fa fa-trash-o"></i></a>';
    }
}