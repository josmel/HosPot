...
class Default_SubsidiaryController extends Core_Controller_ActionDefault
{
    const _TABLECLASS = 'Subsidiary';
    ...
    public function indexAction()
    {
        ...
        if(!$dataCompany) $this->_redirect('/company');
    ...
    public function listAction()
    {
        ...
        try {
            ...
            if(!empty($search['value']))
                $arrSearch[] = array("s.name like ?", '%'.$search['value'].'%');
    ...
    public function tableIcons(){
        return '<a href="/hall/index/id/__ID__" data-target="#tplSchedule" title="Agregar Sala" class="padding-right-small"><i class="fa fa-sitemap"/></i></a>
            <a href="/billboard/index/id/__ID__" data-target="#tplSchedule" title="Campañas" class="padding-right-small"><i class="fa fa-ticket"></i></a>
