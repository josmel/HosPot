...
class Default_HallController extends Core_Controller_ActionDefault
{
    const _TABLECLASS = 'Hall';
    ...
    public function indexAction()
    {
        ...
        if(empty($id)) $this->_redirect('/subsidiary');
        $dataCompany= Default_Model_Subsidiary::getRow($id);
        var_dump();exit;
        if(!$dataCompany) $this->_redirect('/subsidiary');
    ...
    public function listAction()
    {
        ...
        try {
            ...
            if(!empty($search['value']))
                $arrSearch[] = array("h.name like ?", '%'.$search['value'].'%');
    ...
    {
        if(empty($params['name']) || empty($params['idubigeo']) || empty($params['idcompany'])){
    ...
    public function tableIcons(){
        return '<a href="/hall/index/id/__ID__" data-target="#tplSchedule" title="Agregar Sala" class="padding-right-small"><i class="fa fa-sitemap"/></i></a>
            <a href="/price/index/id/__ID__" data-target="#tplSchedule" title="Precios" class="padding-right-small"><i class="fa fa-money"></i></a>
            <a href="/billboard/index/id/__ID__" data-target="#tplSchedule" title="Peliculas" class="padding-right-small"><i class="fa fa-ticket"></i></a>
            <a href="javascript:;" data-id="__ID__" data-target="#tplSubsidiary" title="Editar" class="padding-right-small lnkEdit"><i class="fa fa-pencil"></i></a>
            <a class="lnkDel" data-id="__ID__" title="Eliminar" href="javascript:;"><i class="fa fa-trash-o"></i></a>';
    }
}